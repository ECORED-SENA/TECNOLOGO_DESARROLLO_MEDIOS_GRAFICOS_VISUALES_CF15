  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .col-12.col-md-10.mx-auto.mb-5.pb-0.pb-md-5.img-modal_t_9
      ImagenInfograficaB.color-primario.mb-0.mb-md-5
        ...
        div(x="53%" y="13%" tooltip="Clic para ver más" numero="").d-flex.flex-wrap.flex-md-nowrap.align-items-center
        ...
        div(x="4%" y="33%" tooltip="Clic para ver más" numero="").d-flex.flex-wrap.flex-md-nowrap.align-items-center
        ...
        div(x="38%" y="70%" tooltip="Clic para ver más" numero="").d-flex.flex-wrap.flex-md-nowrap.align-items-center
        ...
        div(x="63%" y="70%" tooltip="Clic para ver más" numero="").d-flex.flex-wrap.flex-md-nowrap.align-items-center
        ...
        div(x="89%" y="70%" tooltip="Clic para ver más" numero="").d-flex.flex-wrap.flex-md-nowrap.align-items-center
        ...
        div(x="25%" y="87%" tooltip="Clic para ver más" numero="").d-flex.flex-wrap.flex-md-nowrap.align-items-center
